...
{% macro default__GenerateRows(
    ...
    {% set _cond_tmp = _cond_tmp | replace('payload.' ~ q_by_adapter, internal_col) %}
    {% set _cond_tmp = _cond_tmp | replace('payload.' ~ backtick_col, internal_col) %}
    {% set _cond_tmp = _cond_tmp | replace('payload.' ~ doubleq_col, internal_col) %}
    {% set _cond_tmp = _cond_tmp | replace('payload.' ~ singleq_col, internal_col) %}
    ...
    {% set condition_expr_sql = condition_expr_sql | replace('payload.gen.', 'gen.') | replace('gen.gen.', 'gen.') | replace('gen.__gen_gen.', 'gen.') %}
    ...
    {% set loop_expr_replaced = loop_expr_replaced | replace('payload.gen.', 'gen.') | replace('gen.gen.', 'gen.') | replace('gen.__gen_gen.', 'gen.') %}
    ...
    {% set recursion_condition = recursion_condition | replace('payload.gen.', 'gen.') | replace('gen.gen.', 'gen.') | replace('gen.__gen_gen.', 'gen.') %}
