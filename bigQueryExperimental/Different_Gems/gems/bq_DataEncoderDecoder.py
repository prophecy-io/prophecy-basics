...
class DataEncoderDecoder(MacroSpec):
    ...
    # Note: AES encrypt is intentionally paused for BigQuery implementation.
    # BigQuery requires AEAD.ENCRYPT with a keyset and a secret access method.
    # UI must be updated to let users choose secret source (e.g., Secret Manager/KMS-wrapped keyset).
