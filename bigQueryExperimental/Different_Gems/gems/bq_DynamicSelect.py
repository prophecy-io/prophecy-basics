...
class DynamicSelect(MacroSpec):
    ...
    projectName: str = "BigQuerySqlBasics"
    ...
    def validate(self, context: SqlContext, component: Component) -> List[Diagnostic]:
        ...
        if component.properties.selectUsing == "SELECT_FIELD_TYPES" and not (
            ...
            component.properties.bytesTypeChecked or
            component.properties.floatTypeChecked or
            component.properties.numericTypeChecked or
            component.properties.dateTypeChecked or
            component.properties.datetimeTypeChecked or
            component.properties.timestampTypeChecked or
            component.properties.timeTypeChecked or
            component.properties.structTypeChecked or
            component.properties.arrayTypeChecked
        ):
            diagnostics.append(
