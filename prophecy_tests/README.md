...
├── snowflake_sql/        # Snowflake SQL tests (⚠️ Coming Soon - dbt unit tests)
│   ├── requirements.txt
│   ├── profiles.yml
│   ├── example_unit_tests.yml
│   └── README.md
├── databricks_sql/       # Databricks SQL tests (⚠️ Coming Soon - dbt unit tests)
│   ├── requirements.txt
│   ├── profiles.yml
│   ├── example_unit_tests.yml
│   └── README.md
...
| `snowflake_sql` | Snowflake SQL macro tests | dbt unit tests | ⚠️ Coming Soon |
| `databricks_sql` | Databricks SQL macro tests | dbt unit tests | ⚠️ Coming Soon |
| `duckdb_sql` | DuckDB SQL macro tests | dbt unit tests | ⚠️ Coming Soon |
